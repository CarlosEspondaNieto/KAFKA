...
class TweetStream(StreamListener):
    ...
    def on_data(self, data):
        ...
        try:
            ...
            bdata = bytes(limpieza, 'utf-8')

            producer.send('test', bdata)

            print(bdata)          



            # se genera la estructura json que requiere eslactic search, solo con algunos campos de nuestro interes.

            #conexion.index(index="sentiment-demo",
